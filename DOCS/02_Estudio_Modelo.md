...
| Dificultad para consultar los horarios de atención de los profesores.                             | Proporcionar información organizada sobre los horarios de atención docente. | El sistema debe permitir consultar los horarios de atención de los profesores.                                              |
| Dificultad para consultar los horarios de los cursos vigentes.                                    | Centralizar y facilitar el acceso a los horarios académicos.                | El sistema debe permitir consultar los horarios de los cursos disponibles.                                                  |
...
| Dificultad para mantener actualizada la información publicada para los estudiantes.               | Proporcionar una plataforma administrativa para gestionar los contenidos.   | El sistema debe permitir a los docentes autorizados crear, modificar y eliminar información, eventos, horarios e imágenes.  |
| Acceso no autorizado a la gestión de la información del sistema.                                  | Controlar el acceso a las funciones administrativas.                        | El sistema debe autenticar a los docentes autorizados antes de permitir el acceso a la plataforma administrativa.           |
